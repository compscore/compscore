...
func (uu *UserUpdate) AddStatuIDs(ids ...int) *UserUpdate {
...
func (uu *UserUpdate) RemoveStatuIDs(ids ...int) *UserUpdate {
...
// AddStatuIDs adds the "status" edge to the Status entity by IDs.
func (uuo *UserUpdateOne) AddStatuIDs(ids ...int) *UserUpdateOne {
...
// RemoveStatuIDs removes the "status" edge to Status entities by IDs.
func (uuo *UserUpdateOne) RemoveStatuIDs(ids ...int) *UserUpdateOne {
