...
func (e RoundEdges) ChecklogsOrErr() ([]*CheckLog, error) {
	if e.loadedTypes[0] {
...
// QueryChecklogs queries the "checklogs" edge of the Round entity.
func (r *Round) QueryChecklogs() *CheckLogQuery {
	return NewRoundClient(r.config).QueryChecklogs(r)
}
