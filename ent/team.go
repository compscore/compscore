...
func (e TeamEdges) ChecklogsOrErr() ([]*CheckLog, error) {
	if e.loadedTypes[0] {
...
// QueryChecklogs queries the "checklogs" edge of the Team entity.
func (t *Team) QueryChecklogs() *CheckLogQuery {
	return NewTeamClient(t.config).QueryChecklogs(t)
}
